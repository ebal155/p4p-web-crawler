...
class warezbb_data_analyser():
    ...
    def print_author_view_averages(self):
        self.myAnalyser.print_to_file(self.caculate_author_view_averages, 
            'overall_author_view_averages.csv')

    def print_author_total_views(self):
        self.myAnalyser.print_to_file(self.get_author_total_views,
            'overall_author_total_views.csv')
